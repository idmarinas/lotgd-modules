...
if ($amber < 100 && $red >= 100)
{
    ...
    if ($buffvalue < 0.3)
    {
        ...
        $title = \LotgdTranslator::t('notify.0.3.title', [ 'deadthOverlord' => $deathOverlord ], 'module-staminasystem');
    ...
    elseif ($buffvalue < 0.6)
    {
        ...
        $title = \LotgdTranslator::t('notify.0.6.title', [ 'deadthOverlord' => $deathOverlord ], 'module-staminasystem');
        $script = stamina_notification($message, $title);
    }
...
if ($red < 100)
{
    ...
    $message = \LotgdTranslator::t('notify.red.message', [ 'deadthOverlord' => $deathOverlord ], 'module-staminasystem');
