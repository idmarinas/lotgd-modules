...
page_header('title.inventory', ['name' => \LotgdSanitize::fullSanitize($session['user']['name'])], $textDomain);
...
rawoutput(\LotgdTheme::renderModuleTemplate('inventory/run/inventory.twig', $params));
