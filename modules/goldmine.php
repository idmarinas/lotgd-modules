...
function goldmine_getmoduleinfo()
{
	return array(
		"name"=>"Gold Mine",
		"version"=>"1.2.0",
		"author"=>"Ville Valtokari modified by `%IDMarinas`0 dragonverde.infommo.es",
		...
		'require' => [
			'staminasystem' => '20090329|Dan Hall, aka Caveman Joe, improbableisland.com',
		],
		"prefs-mounts"=>array(
