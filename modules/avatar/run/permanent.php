...
{
    addnav(['Get permanent free Avatar changes (%s Points)', $permcost], 'runmodule.php?module=avatar&op=permanentconfirm');
}
else
{
    addnav(['Sorry, but you need %s more Donator Points for this option.', $permcost - $pointsavailable], '');
}
