...
output('"`&So you want a personal picture. In this case, please tell me where I have to look (Upload not more than `v%s`& bytes large, allowed fileendings are %s).`7"`n`n', $max_byte_size, $allowed_types);
output('"`&I also have to say that you hereby state you do not violate international copyrights with your picture. Note also, that you hand over therights to your picture to the server as they store (longer than your account maybe exists) and display the image in the respective biographies.`7"`n`n');
