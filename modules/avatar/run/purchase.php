...
if ($pointsavail < $cost)
{
    ...
    {
        output('`7He glances at his ledger, "`&Unfortunately, purchasing a portrait will cost you %s points, and you currently only have %s %s available to spend.`7"', $cost, $pointsavail, translate_inline(1 == $pointsavail ? 'point' : 'points'));
    }
    else
    {
        output('`7He glances at his ledger, "`&Unfortunately, changing your portrait will cost you %s points, and you currently only have %s %s available to spend.`7"', $cost, $pointsavail, translate_inline(1 == $pointsavail ? 'point' : 'points'));
    }
}
else
{
