...
Version 1.1.0 - Fixed a small bug that caused 2 "Return to the Inn" navs to
              show up
...
function sethsong_getmoduleinfo(){
	$info = array(
		...
		"version"=>"1.2.0",
		"author"=>"Eric Stevens, updated for `%IDMarinas`0, dragonverde.infommo.es",
		"category"=>"Inn",
...
function sethsong_sing()
{
	...
	case 0:
		...
		output('`0You receive some stamina!');
		addstamina(50000);
		break;
	case 1:
		...
		output('`0You feel jovial, and gain some stamina.');
		addstamina(25000);
	...
	case 15:
		...
		if ($session['user']['sex'] == SEX_FEMALE){
			...
			output('`0You receive some stamina in your fury!');
			addstamina(25000);
		}
		break;
	case 16:
