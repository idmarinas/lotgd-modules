...
function gardener_dohook($hookname, $args)
{
    ...
    switch ($hookname){
    case 'changesetting':
        if (! $gardens && 'villagename' == $args['setting'])
        {
    ...
    case 'footer-runmodule':
        if ('newbieisland' != httpget('module'))
        {
            break;
        }
        break;
...
function gardener_run()
{
    ...
    elseif ('ask' == $op)
    {
        ...
        $phrases = [
            translate('It is ok to get romantic in an adult manner in the Gardens.').'|0',
            translate('It is ok to hit players in the Gardens.').'|0',
            translate('It is ok to get undressed in the Gardens.').'|0',
            translate('The Gardens are a place where you can use websites and email addresses.').'|0',
            translate('You can be rude to other players in the Gardens.').'|0',
            translate('You can say anything you like in the Gardens.').'|0',
            translate('You may roleplay a violent fight in the Gardens.').'|0',
            translate('You may roleplay a bedroom love scene in the Gardens.').'|0',
            translate('You may roleplay that another player is defenseless.').'|0',
            translate('You may upset other players.').'|0',
            translate('You may try to annoy others.').'|0',
            translate('You may ask every player in the Gardens to marry you.').'|0',
            translate('It is ok to discuss game secrets in the Gardens.').'|0',
            translate('The Gardens are for adults only, so you can speak about anything there.').'|0',
            translate('You may ask players to behave if they are breaking rules.').'|1',
            translate('The Gardens are a good place to rest from fighting.').'|1',
            translate('It is ok to hug other players in the Gardens.').'|1',
            translate('You may roleplay in the Gardens.').'|1',
            translate('You may get married in the Gardens.').'|1',
            translate('You should report players being cruel to others.').'|1'
        ];
