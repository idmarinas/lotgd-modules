...
function unblockmodules_dohook($hookname, $args)
{
    ...
    if ($hookname == 'newbieisland-everyhit-loggedin')
    {
        if (file_exists('modules/idmarinas/unblockmodules/modules.php')) require_once 'modules/idmarinas/unblockmodules/modules.php';
    }
