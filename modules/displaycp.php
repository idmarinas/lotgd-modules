...
function displaycp_dohook($hookname, $args)
{
    ...
    switch ($hookname)
    {
        case 'charstats':
            ...
            {
                if (isset($specialty[$session['user']['specialty']]))
                {
            ...
            {
                $amnt = translate_inline(0 == $session['user']['seenmaster'] ? 'No Viewed' : 'Viewed');
            ...
            {
                if (0 == get_module_setting('wo'))
                {
                    $title = 'Vital Info';
                }

                if (get_module_setting('wo'))
                {
                    $title = 'Personal Info';
                }

                if (2 == get_module_setting('wo'))
                {
                    $title = 'Extra Info';
                }
